...
public class MedicalRecordsStaff_GUI extends JFrame {
	...
	public MedicalRecordsStaff_GUI(RMIInterface look_up)
		...
		personnelEntry = look_up.fillDiary();
		...
		myPanel1.setLayout(new BoxLayout(myPanel, BoxLayout.Y_AXIS));
		myPanel1.add(new JLabel("ID:"));
		myPanel1.add(personnelid);
		myPanel1.add(new JLabel("Name:"));
		myPanel1.add(personnelname);
		myPanel1.add(new JLabel("Surname:"));
		myPanel1.add(personnelsurname);
		myPanel1.add(new JLabel("Email:"));
		myPanel1.add(personnelemail);
		myPanel1.add(new JLabel("Telehone:"));
		myPanel1.add(personnelphone);
		myPanel1.add(new JLabel("Username:"));
		myPanel1.add(personneluser);
		myPanel1.add(new JLabel("Password:"));
		myPanel1.add(personnelpass);
		myPanel1.add(new JLabel("User-Type:"));
		myPanel1.add(comboBoxtype);
		...
		String[] diaryColumns = { "ID", "Name", "Surname", "Email",
				"Telephone", "Username", "UserType" };
