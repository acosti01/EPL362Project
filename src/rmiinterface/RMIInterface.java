...
public interface RMIInterface extends Remote {
	...
	void editPatient(int id, String name, String surname, String email,
			String address, String bday, String tel, String gender)
			throws RemoteException, SQLException;

	public Object[] getClinics() throws SQLException, RemoteException;

	public int addAppointment(int iD, String date, String time, String clinic,
			String clinician, String type, String status)
	...
	public int getClinicianID(String string, String string2)
			throws SQLException, RemoteException;
